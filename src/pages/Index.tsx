...
import { SavedTripsDialog } from "@/components/pdf/SavedTripsDialog";
import { SaveTripDialog } from "@/components/pdf/SaveTripDialog";
import { usePDFExport } from "@/hooks/usePDFExport";
import { Button } from "@/components/ui/button";
import { ScrollArea } from "@/components/ui/scroll-area";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Download, FileText, Eye, Plane, Building2, CalendarDays, AlertCircle, Building, Save } from "lucide-react";
...
const defaultData: ItineraryData = {
  ...
  agencyInfo: {
    name: "الصفوة",
    logoUrl: "",
    email: "info@elsafwa.com",
    phone: "+966 123 456 789",
    website: "www.elsafwa.com",
      ...
      <header className="bg-primary text-primary-foreground py-4 px-6 shadow-lg">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <SavedTripsDialog onLoadTrip={handleLoadTrip} />
            <Button
